interface AlienProps {
  characterRef: React.RefObject<SVGSVGElement>
  leftEyeRef: React.RefObject<SVGCircleElement>
  rightEyeRef: React.RefObject<SVGCircleElement>
  antennaRef: React.RefObject<SVGPathElement>
}
